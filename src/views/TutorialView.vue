...
@media (max-width: 480px) {
  ...
  .step-card, .operation-section, .feature-section, .example-section { padding: 1.25rem; }
  .section-title { font-size: 1.6rem; }
}

/* ════════════════════════════════════════════
   B&W 主题覆盖层 — 覆盖所有旧版彩色样式
   ════════════════════════════════════════════ */
...
.form-input::placeholder { color: var(--text-dim) !important; }
...
.login-btn:disabled { opacity: 0.35 !important; }
.error-message { color: var(--text-muted) !important; background: none !important; border-radius: 2px !important; }
...
/* 教程选择器 */
.tutorial-selector { margin-bottom: 2rem !important; }
.selector-tabs { justify-content: flex-start !important; gap: 0 !important; }
.tab-btn {
  background: transparent !important;
  border: 1px solid var(--border) !important;
...
.tab-btn:hover { background: var(--bg-3) !important; color: var(--text) !important; }
.tab-btn.active {
  background: var(--text) !important;
  color: var(--bg) !important;
  border-color: var(--text) !important;
...
.nav-title { color: var(--text-muted) !important; font-size: 0.7rem !important; letter-spacing: 0.2em; text-transform: uppercase; }
.nav-item {
  border-radius: 0 !important;
...
.nav-item:hover { background: none !important; color: var(--text) !important; }
.nav-item.active { background: none !important; color: var(--text) !important; font-weight: 600; }
...
/* 特性卡片 */
.features-grid { gap: 1px !important; border: 1px solid var(--border); }
.feature-card {
...
.feature-card h4 { color: var(--text) !important; }
...
.code-block pre { background: none !important; border-radius: 0 !important; }
.code-block code { color: rgba(255,255,255,0.85) !important; }
...
/* 链接 */
.external-link { color: var(--text-muted) !important; text-decoration: underline !important; }
...
.practice-card h4 { color: var(--text) !important; }
.practice-card li::before { color: var(--text-dim) !important; }
...
.security-tip h4 { color: var(--text) !important; }
...
.problem-card h4 { color: var(--text-muted) !important; }
.problem-card p  { color: var(--text-muted) !important; }

/* 各类列表 */
.use-case-list li { border-bottom-color: var(--border) !important; color: var(--text-muted); }
.use-cases h3 { color: var(--text) !important; }
.auth-steps li { color: var(--text-muted) !important; }
.auth-steps li::before { color: var(--text-dim) !important; }
